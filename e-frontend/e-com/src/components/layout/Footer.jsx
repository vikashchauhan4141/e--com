    ...
    <footer className="bg-ink-dark text-surface-container-low pt-20 pb-10 mt-stack-lg border-t border-ink-dark">
      <div className="max-w-container mx-auto px-6 lg:px-16 grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        ...
        <div className="flex flex-col gap-4">
          <Link to="/" className="flex items-center gap-3 -ml-2 font-heading font-light text-base tracking-[0.2em] uppercase text-white">
            <img src="/SA%20logo.png" alt="Stylee Atelier" className="h-12 w-auto object-contain scale-110" />
            <span>Stylee <span className="font-semibold text-primary-accent">Atelier</span></span>
          </Link>
